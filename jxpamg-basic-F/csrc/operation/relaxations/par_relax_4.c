...
jxf_hpPAMGRelax4( jxf_hpCSRMatrix *hp_matrix,
               ...
               jxf_ParVector    *Vtemp )
{
   return jxf_PAMGRelax4(jxf_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}
/*!
...
jxf_hpPAMGRelaxAI4( jxf_hpCSRMatrix *hp_matrix,
                 ...
                 jxf_ParVector    *Vtemp )
{
   return jxf_PAMGRelaxAI4(jxf_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}