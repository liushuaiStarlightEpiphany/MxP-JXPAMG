...
jx_hpPAMGRelax5( jx_hpCSRMatrix *hp_matrix,
               ...
               jx_ParVector    *Vtemp )
{
   return jx_PAMGRelax5(jx_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}
/*!
...
jx_hpPAMGRelaxAI5( jx_hpCSRMatrix *hp_matrix,
                 ...
                 jx_ParVector    *Vtemp )
{
   return jx_PAMGRelaxAI5(jx_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}