...
JXF_Int
jxf_hpPAMGRelax0( jxf_hpCSRMatrix *hp_matrix,
               jxf_ParVector    *par_rhs,
               JXF_Int             *cf_marker,
               JXF_Int              relax_points,
               JXF_Real           relax_weight,
               ...
               jxf_ParVector    *Vtemp )
{
   return jxf_PAMGRelax0(jxf_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}
/*!
...
jxf_hpPAMGRelaxAI0( jxf_hpCSRMatrix *hp_matrix,
                 ...
                 jxf_ParVector    *Vtemp )
{
   return jxf_PAMGRelaxAI0(jxf_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}