...
jxf_hpPAMGRelax2( jxf_hpCSRMatrix *par_matrix,
               ...
               jxf_ParVector    *Vtemp )
{
   return jxf_PAMGRelax2(jxf_hpCSRMatrixPar(par_matrix), par_rhs, cf_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}
...
jxf_hpPAMGRelaxAI2( jxf_hpCSRMatrix *hp_matrix,
                 ...
                 jxf_ParVector    *Vtemp )
{
   return jxf_PAMGRelaxAI2(jxf_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}