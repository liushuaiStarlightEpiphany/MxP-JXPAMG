...
jx_hpPAMGRelax2( jx_hpCSRMatrix *par_matrix,
               ...
               jx_ParVector    *Vtemp )
{
   return jx_PAMGRelax2(jx_hpCSRMatrixPar(par_matrix), par_rhs, cf_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}
...
jx_hpPAMGRelaxAI2( jx_hpCSRMatrix *hp_matrix,
                 ...
                 jx_ParVector    *Vtemp )
{
   return jx_PAMGRelaxAI2(jx_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}