...
JX_Int jxf_dot_type = 0;
JX_Int jxf_spmv_type = 0;
// -----------------------------------------
...
int main(int argc, char *argv[])
{
   ...
   coarsen_type = 8;        /* 粗化策略 */
   interp_type = 0;         /* 插值策略 */
   prolong_type = 0;        /* Prolongation SpMV: 0 host, 101 heterogeneous */
   ...
   while (arg_index < argc)
   {
      ...
      else if (strcmp(argv[arg_index], "-prt") == 0)
      {
         arg_index++;
         prolong_type = atoi(argv[arg_index++]);
      }
   ...
   if (print_usage)
   {
      ...
      jx_printf("  -prt <val>     : prolongation SpMV type: 0 host, 101 heterogeneous\n");
   ...
   case 1:
      ...
      RhsFile = "/vol8/home/xtu_pcy/matrix/Jump/rhs_64X64X64.bin";
      file_base = 2;
      break;
   }
