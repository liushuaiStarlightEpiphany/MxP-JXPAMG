...
typedef struct
{
   ...
   jxh_hpCSRMatrix **hp_A_array_H;
   jxf_ParVector **F_array;
   jxf_ParVector **U_array;
   jxf_ParCSRMatrix **P_array;
   jxf_ParCSRMatrix **R_array;
   jxh_ParCSRMatrix **P_array_H;
   jxh_ParCSRMatrix **R_array_H;

   __fp16 *coarse_fp16_AH;
   JXF_Int coarse_fp16_n_global;
   JXF_Real coarse_fp16_scale_A;
   JXF_Int coarse_fp16_ready;
   ...
   JXF_Real **RR_measure_array;
   JXF_Int **RR_marker_array;
...
#define jxf_hpAMGDataAArrayH(amg_data) ((amg_data)->hp_A_array_H)
...
#define jxf_ParAMGDataPArrayH(amg_data) ((amg_data)->P_array_H)
#define jxf_ParAMGDataRArrayH(amg_data) ((amg_data)->R_array_H)

#define jxf_ParAMGDataCoarseFP16AH(amg_data) ((amg_data)->coarse_fp16_AH)
#define jxf_ParAMGDataCoarseFP16NGlobal(amg_data) ((amg_data)->coarse_fp16_n_global)
#define jxf_ParAMGDataCoarseFP16ScaleA(amg_data) ((amg_data)->coarse_fp16_scale_A)
#define jxf_ParAMGDataCoarseFP16Ready(amg_data) ((amg_data)->coarse_fp16_ready)
...
#define jxf_ParAMGDataRRMeasureArray(amg_data) ((amg_data)->RR_measure_array)
#define jxf_ParAMGDataRRMarkerArray(amg_data)  ((amg_data)->RR_marker_array)
...
JXF_Int
jxf_hpPAMGSetup(void *amg_vdata, jxf_hpCSRMatrix *hp_matrix);
JXF_Int
JXF_PAMGSetup_FtoH(void *amg_solver, jxf_hpCSRMatrix *hp_matrix);
JXF_Int
jxf_BuildCoarseFP16Data(void *amg_vdata);
JXF_Int
jxf_ParCSRMatrixFtoH(jxf_ParCSRMatrix *A, jxh_ParCSRMatrix *B, JXF_Int copy_data);
JXF_Int
jxf_CSRMatrixFtoH(jxf_CSRMatrix *A, jxh_CSRMatrix *B, JXF_Int copy_data);
JXF_Int
jxf_ParCSRMatrixHtoF(jxh_ParCSRMatrix *A, jxf_ParCSRMatrix *B, JXF_Int copy_data);
JXF_Int
jxf_CSRMatrixHtoF(jxh_CSRMatrix *A, jxf_CSRMatrix *B, JXF_Int copy_data);

JXF_Int
jxf_CSRMatrixFtoHStats(jxf_CSRMatrix *A_F,
                       jxh_CSRMatrix *A_H,
                       JXF_Int *nnz_out,
                       JXF_Int *raw_overflow_out,
                       JXF_Int *scaled_overflow_out,
                       JXF_Int *zero_after_fp16_out,
                       JXF_Real *max_abs_out,
                       JXF_Real *min_abs_nz_out,
                       JXF_Real *scale_out,
                       JXF_Real *rel_recon_err_out);
JXF_Int
jxf_ParCSRMatrixFtoHRelReconErrStrict(jxf_ParCSRMatrix *A_F,
                                      jxh_ParCSRMatrix *A_H,
                                      JXF_Real *rel_recon_err_out);
...
JXF_Int
jxf_PAMGMeasureRangeRisk(jxf_ParCSRMatrix *par_A,
                         JXF_Int level,
                         JXF_Int debug_flag,
                         JXF_Real range_log_threshold,
                         JXF_Real **measure_range_ptr,
                         JXF_Int **marker_range_ptr);
...
JXF_Int jxf_hpPAMGCycle_v2(void *amg_vdata, jxf_ParVector **F_array, jxf_ParVector **U_array);
...
jxf_hpPAMGRelax(jxf_hpCSRMatrix *hp_matrix,
                ...
                jxf_ParVector *Ztemp);
JXF_Int
jxh_hpPAMGRelax(jxh_hpCSRMatrix *hp_matrix,
                jxf_ParVector *par_rhs,
                JXF_Int *cf_marker,
                JXF_Int relax_type,
                JXF_Int relax_points,
...
jxf_hpPAMGRelaxIF(jxf_hpCSRMatrix *hp_matrix,
                  ...
                  jxf_ParVector *Ztemp);
JXF_Int
jxh_hpPAMGRelaxIF(jxh_hpCSRMatrix *hp_matrix,
                  jxf_ParVector *par_rhs,
                  JXF_Int *cf_marker,
                  JXF_Int relax_type,
                  JXF_Int relax_order,
