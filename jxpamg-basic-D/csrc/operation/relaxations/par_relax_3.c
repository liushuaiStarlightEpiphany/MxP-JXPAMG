...
jx_hpPAMGRelax3( jx_hpCSRMatrix *hp_matrix,
               ...
               jx_ParVector    *Vtemp )
{
   return jx_PAMGRelax3(jx_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}
/*!
...
jx_hpPAMGRelaxAI3( jx_hpCSRMatrix *hp_matrix,
                 ...
                 jx_ParVector    *Vtemp )
{
   return jx_PAMGRelaxAI3(jx_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}