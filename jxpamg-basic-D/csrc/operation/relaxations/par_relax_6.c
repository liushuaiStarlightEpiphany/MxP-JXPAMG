...
jx_hpPAMGRelax6( jx_hpCSRMatrix *hp_matrix,
               ...
               jx_ParVector    *Vtemp )
{
   return jx_PAMGRelax6(jx_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}
/*!
...
jx_hpPAMGRelaxAI6( jx_hpCSRMatrix *hp_matrix,
                 ...
                 jx_ParVector    *Vtemp )
{
   return jx_PAMGRelaxAI6(jx_hpCSRMatrixPar(hp_matrix), par_rhs, cf_marker, relax_marker, relax_points, relax_weight, omega, par_app, Vtemp);
}