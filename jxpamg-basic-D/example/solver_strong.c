...
int main(int argc, char *argv[])
{
   ...
   {
   case 1:
      MatFile = "/home/spring/xingxin/jxpamg-basic-xingxin/matrix/Constant/mat_csr_128X128X128.bin";
      RhsFile = "/home/spring/xingxin/jxpamg-basic-xingxin/matrix/Constant/rhs_128X128X128.bin";
      file_base = 2;
      break;
   case 2:
